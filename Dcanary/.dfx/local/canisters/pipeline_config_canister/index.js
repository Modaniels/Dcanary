...
import { idlFactory } from './pipeline_config_canister.did.js';
export { idlFactory } from './pipeline_config_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PIPELINE_CONFIG_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./pipeline_config_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the pipeline_config_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./pipeline_config_canister.did.js")._SERVICE>}
 */
export const pipeline_config_canister = createActor(canisterId);
