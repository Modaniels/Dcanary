...
import { idlFactory } from './deployment_canister.did.js';
export { idlFactory } from './deployment_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_DEPLOYMENT_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./deployment_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the deployment_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./deployment_canister.did.js")._SERVICE>}
 */
export const deployment_canister = createActor(canisterId);
