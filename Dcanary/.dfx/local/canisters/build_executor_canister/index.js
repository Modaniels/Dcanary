...
import { idlFactory } from './build_executor_canister.did.js';
export { idlFactory } from './build_executor_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_BUILD_EXECUTOR_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./build_executor_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the build_executor_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./build_executor_canister.did.js")._SERVICE>}
 */
export const build_executor_canister = createActor(canisterId);
