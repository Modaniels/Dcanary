...
import { idlFactory } from './verification_canister.did.js';
export { idlFactory } from './verification_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_VERIFICATION_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./verification_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the verification_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./verification_canister.did.js")._SERVICE>}
 */
export const verification_canister = createActor(canisterId);
