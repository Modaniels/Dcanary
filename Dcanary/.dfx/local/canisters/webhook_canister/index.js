...
import { idlFactory } from './webhook_canister.did.js';
export { idlFactory } from './webhook_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_WEBHOOK_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./webhook_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the webhook_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./webhook_canister.did.js")._SERVICE>}
 */
export const webhook_canister = createActor(canisterId);
